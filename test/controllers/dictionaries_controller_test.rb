...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { description: @dictionary.description, name: @dictionary.name } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { description: @dictionary.description, name: @dictionary.name } }
