...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { lan_code: @language.lan_code, name: @language.name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { lan_code: @language.lan_code, name: @language.name } }
